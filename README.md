...
- `-ExceptionListPath` (Required): Path to a text file with ObjectSIDs to exclude from analysis.
- `-LogFilePath` (Required): Path to the log file for recording actions and errors.
